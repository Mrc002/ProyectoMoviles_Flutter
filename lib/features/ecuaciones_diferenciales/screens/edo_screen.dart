...
class _EdoScreenState extends State<EdoScreen> {
  ...
  void _showAssistant(BuildContext context, Color color) {
    // Contexto general para la IA ya que estamos en el menú de EDOs
    String contexto = "El usuario está en el menú principal de Ecuaciones Diferenciales Ordinarias (EDOs) explorando los temas disponibles.";
    ...
    showModalBottomSheet(
      ...
      builder: (context) => _MiniChatAssistantEdo(contextoDatos: contexto, colorTema: color)
    );
  }
}

// WIDGET DEL MINI-CHAT PARA LA PANTALLA EDO
class _MiniChatAssistantEdo extends StatefulWidget {
  final String contextoDatos; 
  final Color colorTema;
  
  const _MiniChatAssistantEdo({required this.contextoDatos, required this.colorTema});
                ...
                Expanded(
                  child: TextField(
                    ...
                    decoration: InputDecoration(
                      hintText: "¿Tienes alguna duda general?", 
