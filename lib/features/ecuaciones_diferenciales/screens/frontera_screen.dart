...
class _FronteraScreenState extends State<FronteraScreen> {
                  ...
                  return Card(
                    ...
                    child: ListTile(
                      leading: CircleAvatar(
                        ...
                        child: Icon(Icons.border_outer, color: primaryColor), // Ícono de frontera
                      ),
                      title: Text(
  ...
  void _showAssistant(BuildContext context, Color color) {
    ...
    String contexto = "El usuario está en el menú principal de Problemas de Valores en la Frontera explorando los temas disponibles, basados en el libro de Edwards & Penney.";
    ...
    showModalBottomSheet(
      ...
      builder: (context) => _MiniChatAssistantFrontera(contextoDatos: contexto, colorTema: color)
    );
  }
}

// =========================================================================
// WIDGET DEL MINI-CHAT PARA LA PANTALLA FRONTERA
// =========================================================================
class _MiniChatAssistantFrontera extends StatefulWidget {
  final String contextoDatos; 
  final Color colorTema;
  
  const _MiniChatAssistantFrontera({required this.contextoDatos, required this.colorTema});
  
  @override
  State<_MiniChatAssistantFrontera> createState() => _MiniChatAssistantFronteraState();
}

class _MiniChatAssistantFronteraState extends State<_MiniChatAssistantFrontera> {
      ...
      child: Column(
        children: [
          Container(
            ...
            child: Row(
              children: [
                Icon(Icons.border_outer, color: widget.colorTema), 
                ...
                Expanded(
                  child: TextField(
                    ...
                    decoration: InputDecoration(
                      hintText: "¿Dudas sobre Valores en la Frontera?", 
