...
class _EdpScreenState extends State<EdpScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    // Color cyan asignado en el GridView
    final primaryColor = const Color(0xFF00ACC1);
                ...
                itemBuilder: (context, index) {
                  ...
                  return Card(
                    ...
                    child: ListTile(
                      ...
                      subtitle: Text(
                        'Fuente: ${tema['bibliografia'] ?? 'Weinberger'}',
  ...
  void _showAssistant(BuildContext context, Color color) {
    String contexto = "El usuario está en el menú principal de Ecuaciones en Derivadas Parciales (EDPs).";
